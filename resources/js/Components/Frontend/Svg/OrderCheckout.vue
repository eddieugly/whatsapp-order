<template>
  ...
  <g id="freepik--Character--inject-33">
    ...
    <path d="M154.07,269.34l5,1.94-5.62,3.39s-3.59-2.08-3.5-4.76l.55-.31A4.19,4.19,0,0,1,154.07,269.34Z"
      style="fill:#ffb573"></path>
    <polygon points="162.14 274.95 157.91 278.47 153.43 274.67 159.05 271.28 162.14 274.95" style="fill:#ffb573">
    </polygon>
    <path
    ...
    <path d="M100.8,238.78l2.44.71.84-1.78s13.6,4.7,19.52,2.44c3.82-1.46,5.17-2.93,5.17-2.93l-28.72-2.11Z"
      style="opacity:0.2"></path>
    <polygon points="111.03 409.71 117.49 409.71 120.13 394.77 113.68 394.77 111.03 409.71" style="fill:#ffb573">
    </polygon>
    <path
    ...
    <path
      ...
      style="opacity:0.2"></path>
    <polygon points="54.81 352.01 56.99 358.08 71.85 355.28 69.68 349.2 54.81 352.01" style="fill:#ffb573"></polygon>
    <path
    ...
    <path d="M120.5,204.05a13.9,13.9,0,0,0,2.39,3,2.22,2.22,0,0,1-1.77.65Z" style="fill:#ed893e"></path>
    <path
    ...
    <path
      ...
      style="fill:#ffb573"></path>
    <path d="M137.42,224.36l3.94-5.76,1.75,6.32s-3,2.9-5.52,2.09Z" style="fill:#ffb573"></path>
    <polygon points="146.53 216.96 147.71 222.33 143.11 224.92 141.36 218.6 146.53 216.96" style="fill:#ffb573">
    </polygon>
