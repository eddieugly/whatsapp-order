    ...
    <div v-else class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="mx-auto max-w-screen-xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="rounded-lg md:w-8/12">
          <div v-for="menu in cart" :key="menu.id"
            ...
            <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              ...
              <div class="flex justify-between space-x-4">
                <div class="flex items-center border-gray-100">
                  <button :disabled="menu.quantity === 1" @click="minusQuantity(menu.id)"
                    class="cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-yellow-700 hover:text-blue-50">
                    <span>
                      -
                    </span>
                  </button>
                  <input class="h-8 w-8 border bg-white text-center text-xs outline-none" type="numeric"
                    :value="menu.quantity" min="1" />
                  <button @click="addQuantity(menu.id)"
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-4/12">
          ...
          <div class="flex justify-between">
            ...
            <div class="">
              <p class="mb-1 text-right text-lg font-bold">₦{{ total.toLocaleString() }}</p>
