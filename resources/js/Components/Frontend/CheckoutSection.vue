        ...
        <div class="px-4 pt-8">
          ...
          <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div v-for="menu in cart" :key="menu.id" class="flex flex-col rounded-lg bg-white sm:flex-row">
              <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" :src="menu.thumbnail" alt="Menu Thumbnail" />
          ...
          <form class="mt-5 grid gap-6">
            ...
            <div class="relative">
              ...
              <span class="peer-checked:border-yellow-500 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-yellow-100 bg-white"></span>
              <label class="peer-checked:border-2 peer-checked:border-yellow-500 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-yellow-300 p-4" for="radio_2" >
                <OrderNow />
                <div class="ml-5">
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <div class="">
            <form @submit.prevent="submit">
              ...
              >
              <div class="relative">
                <input v-model="form.customer_name" type="text" id="customer-name" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-yellow-500 focus:ring-yellow-500" placeholder="Ahmed Hassan" required />
              ...
              <div class="relative">
                <input v-model="form.customer_email" type="email" id="customer-email" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-yellow-500 focus:ring-yellow-500" placeholder="johndoe@example.com" required />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
              ...
              <div class="relative">
                <input v-model="form.customer_phone" type="text" id="customer-phone" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-yellow-500 focus:ring-yellow-500" placeholder="08133001122" />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
