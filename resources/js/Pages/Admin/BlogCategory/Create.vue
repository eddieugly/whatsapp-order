            ...
            <div class="items-center p-5 sm:p-8 lg:p-10 mx-auto max-w-2xl rounded">
                <form @submit.prevent="submit">
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="mb-4">
                            <Input v-model="form.slug" name="slug" id="slug" placeholder="Slug" label="Blog Category Slug">
                        ...
                        <div class="mb-4 sm:col-span-2">
                            ...
                            <TextAreaGroup label="Blog Category Description" :error-message="form.errors.description" v-model="form.description" />
                        </div>
                        <div class="mb-4 sm:col-span-2">
