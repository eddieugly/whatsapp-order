    ...
    <AuthenticatesLayout>
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                <div class="items-center p-5 sm:p-8 lg:p-10 mx-auto max-w-2xl rounded bg-gray-50 dark:bg-gray-800">
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                <Input v-model="form.slug" name="slug" id="slug" placeholder="Slug"
                                    label="Category Name">
