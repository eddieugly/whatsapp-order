...
const form = useForm({
  generalID: page.props.generalID,
      ...
      <form @submit.prevent="update">
        <div class="grid gap-4 sm:grid-cols-2">
          ...
          <div class="mb-4 sm:col-span-2">
            <Input @input="form.company_logo_white = $event.target.files[0]" type="file" name="company_logo_white" id="company_logo_white"
          ...
          <div class="mb-4 sm:col-span-2">
            <Input @input="form.company_logo_dark = $event.target.files[0]" type="file" name="company_logo_dark" id="company_logo_dark"
          ...
          <div class="mb-4 sm:col-span-2">
            <Input @input="form.company_favicon = $event.target.files[0]" type="file" name="company_favicon" id="company_favicon"
