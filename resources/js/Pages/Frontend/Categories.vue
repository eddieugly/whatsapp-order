<template>
  ...
  <FrontEndLayout>
    ...
    <CategoriesBreadcrumbs current-page="All Categories" middle-page="Categories" :middle-page-link="route('frontend.categories')" />

    <CategorySection :categories="all_categories" />
...
import CategorySection from '@/Components/Frontend/CategorySection.vue';
