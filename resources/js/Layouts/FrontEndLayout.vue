    ...
    <header>
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <aside id="default-sidebar-0909"
            class="sm:hidden lg:hidden fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
            aria-label="Sidenav" aria-labelledby="default-sidebar-0909">
            <div
